---
layout: default
title: "Evidence Node: hodataistvo_rodstvo (копия).подписан.pdf"
date: 2026-05-15
...
- **Файл:** hodataistvo_rodstvo (копия).подписан.pdf
- **SHA-256:** $sha

**Инструкция по извлечению подлинника:**
`powershell
Get-CloudFileByHash "B869931F03FF1A014294A9EC77948C7F05E29D4B925F28680FD07650129BF930"
 `
