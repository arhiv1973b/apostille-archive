---
layout: default
title: "Evidence Node: Scenariu_Marinescu (копия).подписан.pdf"
date: 2026-05-15
...
- **Файл:** Scenariu_Marinescu (копия).подписан.pdf
- **SHA-256:** $sha

**Инструкция по извлечению подлинника:**
`powershell
Get-CloudFileByHash "D95229859A25381C4310A2FD62D3546DD9498B2A80E9159E4AD7CEF4A790D669"
 `
