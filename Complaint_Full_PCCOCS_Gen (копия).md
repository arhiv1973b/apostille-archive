---
layout: default
title: "Evidence Node: Complaint_Full_PCCOCS_Gen (копия).pdf"
date: 2026-05-15
...
- **Файл:** Complaint_Full_PCCOCS_Gen (копия).pdf
- **SHA-256:** $sha

**Инструкция по извлечению подлинника:**
`powershell
Get-CloudFileByHash "C61E61671388F05658E0996461C897D8692C130F2D245D71C1C4D47182EC9259"
 `
